...
# terraform destroy -var-file="vars-staging.tfvars" -state="terraform-staging.tfstate"
...
acorns_environment = ["staging"]
cpln_org = "acorns-staging"
cpln_locations = ["aws-us-east-2"]
cpln_token = ""
cpln_gvc = "proxy"

external_apex_domain = "acorns.io"
external_domain = "controlplane.staging.acorns.io"
